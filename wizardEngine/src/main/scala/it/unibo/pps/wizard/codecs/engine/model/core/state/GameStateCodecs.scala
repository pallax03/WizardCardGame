...
import it.unibo.pps.wizard.engine.model.core.state.{GameState, PlayerCoreState, PlayerGameState, ServerCoreState, ServerGameState}
...
object GameStateCodecs:
  ...
  // Server Codecs
  given serverChoosingTrumpCodec: Codec[GameState.ChoosingTrump[ServerCoreState]] = Codec.AsObject.derived
  ...
  // Player Codecs
  given playerChoosingTrumpCodec: Codec[GameState.ChoosingTrump[PlayerCoreState]] = Codec.AsObject.derived

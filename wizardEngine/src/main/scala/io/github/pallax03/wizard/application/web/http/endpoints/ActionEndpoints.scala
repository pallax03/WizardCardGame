...
object ActionEndpoints:
  ...
  val chooseAction: Endpoint[String, (LobbyId, Card.Color), ResponseErrors, ActionSuccessResponse, Any] =
    base
  ...
  val placeAction: Endpoint[String, (LobbyId, Bid), ResponseErrors, ActionSuccessResponse, Any] =
    base
      .summary("Place bid")
  ...
  val playAction: Endpoint[String, (LobbyId, Card), ResponseErrors, ActionSuccessResponse, Any] =
    base
      .summary("Play card")

...
object ActionEndpoints:
  ...
  val chooseAction: Endpoint[String, (LobbyId, Card.Color), AppError, ActionSuccessResponse, Any] =
    base
  ...
  val placeAction: Endpoint[String, (LobbyId, Bid), AppError, ActionSuccessResponse, Any] =
    base
      .summary("Place bid")
  ...
  val playAction: Endpoint[String, (LobbyId, Card), AppError, ActionSuccessResponse, Any] =
    base
      .summary("Play card")

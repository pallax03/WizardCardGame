...
import it.unibo.pps.wizard.engine.model.core.state.{PlayerCoreState, ServerCoreState}
...
class TestCoreStateCodecs extends AnyWordSpec with Matchers:
  ...
  "CoreStateCodecs" should:
    ...
    "encode and decode PlayerCoreState correctly" in:
      ...
      println(jsonString)
//      jsonString shouldBe """"""
      jsonString.decodeAs[PlayerCoreState].value shouldBe PlayerCoreState.from(core, p1).toOption.get